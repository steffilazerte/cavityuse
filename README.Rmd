...
You can use the `tz_find_offset` function to determine what timezone this would be, and the `with_tz` function from the lubridate package to assign this timezone to your data:
